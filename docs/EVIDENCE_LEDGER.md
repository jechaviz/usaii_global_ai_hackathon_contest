...
| Qualifier rehearsal | done | `submission/qualifier_rehearsal_kit.md` | Eight-question drill for Health, Sustainability, and Community qualifier themes. |
...
| Build-window compliance template | done | `submission/build_window_compliance_log.template.md` | Prevents overclaiming pre-window scaffold work. |
| AI tools disclosure template | done | `submission/ai_tools_disclosure.template.md` | Devpost-ready disclosure checklist. |
